...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN]   = { {  KC_GRV,   KC_F1,    KC_F2,    KC_F3,  KC_F4,  KC_F5,    KC_F6,  KC_F7,  KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_NO    },
                {  KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NO,  KC_NO,    KC_NO,  KC_NO,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO    },
                {  KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NO,  KC_NO,    KC_NO,  KC_NO,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    RGB_VAI  },
                {  KC_LSFT,  KC_NO,    KC_NO,    KC_NO,  KC_NO,  KC_NO,    KC_NO,  KC_NO,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_NO,    KC_PGUP,  RGB_SPI  },
...
void rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    if (IS_HOST_LED_ON(USB_LED_CAPS_LOCK)) {
        //RGB_MATRIX_INDICATOR_SET_COLOR(28, 255,255,255); //capslock key
